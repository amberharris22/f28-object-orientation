...
/*
  After you've made your object, use bracket or dot notation to add another key named 'car' with the value being 
  your favorite car and then another key named 'show' with the value being your favorite show.
*/
//Code here
...
function ingredients(){
  ...
  const {carb, fat, protein} = properties
  let ing = []
...
user.email = 'BryanSmith33@gmail.com'
// console.log(user)
...
let cat1 = new Cat('Garfield', 8, 'orange')

console.log(cat1.name)

//////////////////////////// PROBLEM 13 ////////////////////////////
/*
  Create a class called 'Wizard'. Make sure to call your constructor, and require these 3 parameters: name, age, 
  favoriteSpell.
...
//Code Here
let phone1 = new Phone('apple', '14', '258', 'white', '1000')
let phone2 = new Phone('android', 's20', '126', 'black', '800')
let phone3 = new Phone('google', 'pixel', '258', 'blue', '750')
/* 
...
//Code Here
let myFirstVehicle = new Vehicle(5, 'black', 2000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'red', 1000, 'Harley', true)
/*
...
//Code Here
let myFirstBoat = new Boat (8, 'green', 250, 'puddleJumper', 'yacht', false)
/*
